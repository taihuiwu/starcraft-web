...
1. ✅ **3D 模型缺失** — 已添加 GLTFLoader 支持，保留几何体 fallback
2. ✅ **多人同步延迟** — 已添加插值/外推/延迟补偿
3. ✅ **AI 决策深度有限** — 已添加空投/运输逻辑和智能扩张评分
4. ✅ **空中单位** — 已添加完整空军战斗逻辑（isFlying, antiAir, 飞行高度）
5. ✅ **存档兼容性** — 已添加版本迁移、压缩、损坏恢复
6. ✅ **移动端性能** — 已添加自动降级、LOD、DPR 优化、draw call 批量合并
7. ✅ **浏览器兼容** — 已配置 .browserslistrc 和 babel
8. ⚠️ **地图编辑器** — 已有撤销/重做，正在添加高级编辑工具（部分修复）
9. ✅ **音效资源** — 已升级为 FM 合成 + ADSR 包络 + 3D 空间音效
